		...
		var wqueen = randomInt(3, 3);
		var bbishop = randomInt(0, 0);
		var wbishop = randomInt(3, 3);
		var bknight = randomInt(0, 0);
		var wknight = randomInt(3, 3);
		var brook = randomInt(0, 0);
		var wrook = randomInt(1, 1);
		/*var bpawn = 0;
		var wpawn = 0;
		var bqueen = 0;
		var wqueen = 0;
		...
		var N = ["officialtreven37 20", "salmanaume 17"];
		var B = ["ginkacecelia 0", "kokoderecho 19"];
		var K = [];
		var R = ["ginkacecelia 0", "officialtreven37 20", "salmanaume 17", "kokoderecho 19"];
			...
			if (condition1 && condition2) {
				guy.push(where);
						if(i<realFollowers) {
							...
							document.querySelectorAll('.white, .black, .removed')[where].innerHTML = `<img class="char bot" src="bP.png"/><img class="class" id="${where}"/><img class="class2" id="${where}"/><h5 class="h5bot" id="i${where}">${where}</h5>`;
							bpawn -= 1;
						} else if(wpawn > 0) {
							for(let i=1; i<botLvl; i++) {
								guy.push(where);
							}
							document.querySelectorAll('.white, .black, .removed')[where].innerHTML = `<img class="char bot" src="wP.png"/><img class="class" id="${where}"/><img class="class2" id="${where}"/><h5 class="h5bot" id="i${where}">${where}</h5>`;
							wpawn -= 1;
						} else if(bknight > 0) {
							for(let i=1; i<botLvl; i++) {
								guy.push(where);
							}
							document.querySelectorAll('.white, .black, .removed')[where].innerHTML = `<img class="char bot" src="bN.png"/><img class="class" id="${where}"/><img class="class2" id="${where}"/><h5 class="h5bot" id="i${where}">${where}</h5>`;
							bknight -= 1;
						} else if(wknight > 0) {
							for(let i=1; i<botLvl; i++) {
								guy.push(where);
							}
							document.querySelectorAll('.white, .black, .removed')[where].innerHTML = `<img class="char bot" src="wN.png"/><img class="class" id="${where}"/><img class="class2" id="${where}"/><h5 class="h5bot" id="i${where}">${where}</h5>`;
							wknight -= 1;
						} else if(bbishop > 0) {
							for(let i=1; i<botLvl; i++) {
								guy.push(where);
							}
							document.querySelectorAll('.white, .black, .removed')[where].innerHTML = `<img class="char bot" src="bB.png"/><img class="class" id="${where}"/><img class="class2" id="${where}"/><h5 class="h5bot" id="i${where}">${where}</h5>`;
							bbishop -= 1;
						} else if(wbishop > 0) {
							for(let i=1; i<botLvl; i++) {
								guy.push(where);
							}
							document.querySelectorAll('.white, .black, .removed')[where].innerHTML = `<img class="char bot" src="wB.png"/><img class="class" id="${where}"/><img class="class2" id="${where}"/><h5 class="h5bot" id="i${where}">${where}</h5>`;
							wbishop -= 1;
						} else if(brook > 0) {
							for(let i=1; i<botLvl; i++) {
								guy.push(where);
							}
							document.querySelectorAll('.white, .black, .removed')[where].innerHTML = `<img class="char bot" src="bR.png"/><img class="class" id="${where}"/><img class="class2" id="${where}"/><h5 class="h5bot" id="i${where}">${where}</h5>`;
							brook -= 1;
						} else if(wrook > 0) {
							for(let i=1; i<botLvl; i++) {
								guy.push(where);
							}
							document.querySelectorAll('.white, .black, .removed')[where].innerHTML = `<img class="char bot" src="wR.png"/><img class="class" id="${where}"/><img class="class2" id="${where}"/><h5 class="h5bot" id="i${where}">${where}</h5>`;
							wrook -= 1;
						} else if(bqueen > 0) {
							for(let i=1; i<botLvl; i++) {
								guy.push(where);
							}
							document.querySelectorAll('.white, .black, .removed')[where].innerHTML = `<img class="char bot" src="bQ.png"/><img class="class" id="${where}"/><img class="class2" id="${where}"/><h5 class="h5bot" id="i${where}">${where}</h5>`;
							bqueen -= 1;
						} else if(wqueen > 0) {
							for(let i=1; i<botLvl; i++) {
								guy.push(where);
							}
							document.querySelectorAll('.white, .black, .removed')[where].innerHTML = `<img class="char bot" src="wQ.png"/><img class="class" id="${where}"/><img class="class2" id="${where}"/><h5 class="h5bot" id="i${where}">${where}</h5>`;
							wqueen -= 1;
						} else if(bking > 0) {
							for(let i=1; i<botLvl; i++) {
								guy.push(where);
							}
							document.querySelectorAll('.white, .black, .removed')[where].innerHTML = `<img class="char bot" src="bK.png"/><img class="class" id="${where}"/><img class="class2" id="${where}"/><h5 class="h5bot" id="i${where}">${where}</h5>`;
							bking -= 1;
						} else if(wking > 0) {
							for(let i=1; i<botLvl; i++) {
								guy.push(where);
							}
							document.querySelectorAll('.white, .black, .removed')[where].innerHTML = `<img class="char bot" src="wK.png"/><img class="class" id="${where}"/><img class="class2" id="${where}"/><h5 class="h5bot" id="i${where}">${where}</h5>`;
							wking -= 1;
						}
