		//adjustable
		var movePerUnit = 1;
		var totalTime = 5000; //in sec
		var time = 1;
		var highNum = Math.round(Math.random()*3);
		var a = highNum == 0 ? Math.round(Math.random()*9) : Math.round(Math.random()*9);
		var b = highNum == 1 ? Math.round(Math.random()*9) : Math.round(Math.random()*9);
		var c = highNum == 2 ? Math.round(Math.random()*9) : Math.round(Math.random()*9);
		var d = highNum == 3 ? Math.round(Math.random()*9) : Math.round(Math.random()*9);
		var prob = Math.round(Math.random()*23);
		var e;
		var guessWord = "0000000000";
...
shuffle(guessWord);*/
		...
		if(prob==0) {
			...
			e = a-b*c+d;
			guessWord = `${a} - ${b} &#215 ${c} + ${d} = ${e}`;
		} else if(prob==14) {
			e = a-b*c-d;
			guessWord = `${a} - ${b} &#215 ${c} - ${d} = ${e}`;
		} else if(prob==15) {
			e = a-b*c*d;
			guessWord = `${a} - ${b} &#215 ${c} &#215 ${d} = ${e}`;
		} else if(prob==16) {
			e = a*b+c+d;
			guessWord = `${a} &#215 ${b} + ${c} + ${d} = ${e}`;
		} else if(prob==17) {
			e = a*b+c-d;
			guessWord = `${a} &#215 ${b} + ${c} - ${d} = ${e}`;
		} else if(prob==18) {
			e = a*b+c*d;
			guessWord = `${a} &#215 ${b} + ${c} &#215 ${d} = ${e}`;
		} else if(prob==19) {
			e = a*b-c+d;
			guessWord = `${a} &#215 ${b} - ${c} + ${d} = ${e}`;
		} else if(prob==20) {
		...
		*/
		...
		function changePiece(z, piece) {
						for(let k=1; k<3; k++) {
							if(document.querySelectorAll('.white, .black, .removed')[z].getElementsByTagName('img')[k].src.includes("wN")) {
								document.querySelectorAll('.white, .black, .removed')[z].getElementsByTagName('img')[k].style.height = '66%';
								document.querySelectorAll('.white, .black, .removed')[z].getElementsByTagName('img')[k].style.zIndex = '1';
								document.querySelectorAll('.white, .black, .removed')[z].getElementsByTagName('img')[k].style.width = '66%';
								document.querySelectorAll('.white, .black, .removed')[z].getElementsByTagName('img')[k].style.position = 'absolute';
								document.querySelectorAll('.white, .black, .removed')[z].getElementsByTagName('img')[k].style.bottom= '0';
								document.querySelectorAll('.white, .black, .removed')[z].getElementsByTagName('img')[k].style.right = '0';
							} else {
								document.querySelectorAll('.white, .black, .removed')[z].getElementsByTagName('img')[k].style.height = '66%';
								document.querySelectorAll('.white, .black, .removed')[z].getElementsByTagName('img')[k].style.width = '66%';
								document.querySelectorAll('.white, .black, .removed')[z].getElementsByTagName('img')[k].style.zIndex = '2';
								document.querySelectorAll('.white, .black, .removed')[z].getElementsByTagName('img')[k].style.position = 'absolute';
								document.querySelectorAll('.white, .black, .removed')[z].getElementsByTagName('img')[k].style.top = '0';
								document.querySelectorAll('.white, .black, .removed')[z].getElementsByTagName('img')[k].style.left = '0';
							}
		...
		function move(pos, z, random) {
			...
			if(removed.includes(x+' '+y)) {
				...
				let letterJump = setInterval(function() {
					if(document.querySelectorAll('.white, .black, .removed')[pos].innerHTML == ""){
						document.querySelectorAll('.white, .black, .removed')[pos].innerHTML = guessWord[guessWord.length-1 - countSquare] === "0"?`<img id="dont" src="dont.svg" />`:"";
						countSquare++;
						clearInterval(letterJump);
					}
				}, 750);
				...
				//document.querySelectorAll('.white, .black, .removed')[pos].innerHTML = `<img src="dont.svg" />`;
		...
		function randomRemoveSquare() {
			//code if few people left
					...
					if(document.querySelectorAll('.white, .black, .removed')[remove].getElementsByTagName('img').length == 0 && !removed.includes(x+' '+y)) {
						...
						document.querySelectorAll('.white, .black, .removed')[remove].innerHTML = `<img src="dont.svg" />`;
					} else {
						randomRemoveSquare();
					}
		}
